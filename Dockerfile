...
COPY --from=build /root/rsunimrcp_tts/target/release/librsunimrcp_tts.so /usr/local/unimrcp/plugin/librsunimrcp_tts.so
COPY ./unimrcpserver.xml /usr/local/unimrcp/conf/unimrcpserver.xml

ENV RUST_LOG="rsunimrcp_tts=trace, rsunimrcp_engine=trace"
